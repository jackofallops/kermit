...
// FileImportsClientAPI contains the set of methods on the FileImportsClient type.
type FileImportsClientAPI interface {
	Create(ctx context.Context, resourceGroupName string, workspaceName string, fileImportID string, fileImport securityinsight.FileImport) (result securityinsight.FileImport, err error)
	Delete(ctx context.Context, resourceGroupName string, workspaceName string, fileImportID string) (result securityinsight.FileImportsDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, workspaceName string, fileImportID string) (result securityinsight.FileImport, err error)
	List(ctx context.Context, resourceGroupName string, workspaceName string, filter string, orderby string, top *int32, skipToken string) (result securityinsight.FileImportListPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, workspaceName string, filter string, orderby string, top *int32, skipToken string) (result securityinsight.FileImportListIterator, err error)
}

var _ FileImportsClientAPI = (*securityinsight.FileImportsClient)(nil)
...
// SecurityMLAnalyticsSettingsClientAPI contains the set of methods on the SecurityMLAnalyticsSettingsClient type.
type SecurityMLAnalyticsSettingsClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, workspaceName string, settingsResourceName string, securityMLAnalyticsSetting securityinsight.BasicSecurityMLAnalyticsSetting) (result securityinsight.SecurityMLAnalyticsSettingModel, err error)
	Delete(ctx context.Context, resourceGroupName string, workspaceName string, settingsResourceName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, workspaceName string, settingsResourceName string) (result securityinsight.SecurityMLAnalyticsSettingModel, err error)
	List(ctx context.Context, resourceGroupName string, workspaceName string) (result securityinsight.SecurityMLAnalyticsSettingsListPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, workspaceName string) (result securityinsight.SecurityMLAnalyticsSettingsListIterator, err error)
}

var _ SecurityMLAnalyticsSettingsClientAPI = (*securityinsight.SecurityMLAnalyticsSettingsClient)(nil)
